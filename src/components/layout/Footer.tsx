      ...
      <div className="section-padding pt-20 pb-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Luxury Sedans', 'Executive SUVs', 'Mercedes Sprinter', 'Stretch Limousine', 'View All Vehicles'].map((v) => (
                <li key={v}>
                  <Link to="/fleet" className="font-body text-sm text-silver/70 hover:text-gold transition-colors">
                    {v}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link to="/contact" className="font-body text-xs text-silver/50 hover:text-gold transition-colors">Privacy Policy</Link>
            <Link to="/contact" className="font-body text-xs text-silver/50 hover:text-gold transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
